...
const PortfolioGridLoader: FC = async () => {
  return (
        ...
        >
          <div className="group relative flex w-full flex-col justify-center">
            <figure className="relative flex min-h-[320px] w-full flex-col overflow-hidden bg-slate-100">
              <div className="gallery-card-img relative h-[320px] w-full object-cover duration-500 group-hover:scale-125 group-hover:transition-transform"></div>
            </figure>
          </div>
        </CardAnimations>
      ))}
